...
#SBATCH --output=/home/x-kyang10/Surya/downstream_examples/ar_segmentation/logs/unet_test_%j.log
#SBATCH --error=/home/x-kyang10/Surya/downstream_examples/ar_segmentation/logs/unet_test_%j.err
